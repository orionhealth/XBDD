...
test("TagListButtonsView renders", () => {
    const buttonView = shallow(
        <TagListFilterButtonsView filterStates={filterStates} onFilterButtonClick={() => {}} />
    );
...
test("TagListButtonsView renders button with secondary color when not selected", () => {
    ...
    const buttonView = mount(
        <TagListFilterButtonsView filterStates={filterStatesFalse} onFilterButtonClick={() => {}} />
    );
